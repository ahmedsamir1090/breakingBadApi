        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            body: ConditionalBuilder(
              ...
              fallback: (context) => SpinKitSquareCircle(color: Colors.lime),
              // Image.asset(
          ...
          child: Stack(
            ...
            children: [
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              "${BbCubit.get(context).season1[index]['air_date']}",
                              style: TextStyle(
              ...
              Container(
                ...
                child: Center(
                  child: Text(
                    "episode ${BbCubit.get(context).season1[index]['episode']}",
                    style: TextStyle(
                        color: Colors.white,
