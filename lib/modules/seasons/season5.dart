          ...
          builder: (context, state) {
            ...
            return Scaffold(
              ...
              body: ConditionalBuilder(
                ...
                fallback: (context) =>
                    const Center(child: SpinKitThreeInOut(color: Colors.lime)),
              ),
            );
          }),
    );
          ...
          child: Stack(
            ...
            children: [
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              "${BbCubit.get(context).season5[index]['air_date']}",
                              style: TextStyle(
              ...
              Container(
                ...
                child: Center(
                  child: Text(
                    "episode ${BbCubit.get(context).season5[index]['episode']}",
                    style: TextStyle(
                        color: Colors.white,
