...
class Season2Screen extends StatelessWidget {
  static const String id = 'Season2Screen';

  const Season2Screen({super.key});
          ...
          builder: (context, state) {
            ...
            return Scaffold(
              ...
              body: ConditionalBuilder(
                ...
                fallback: (context) =>
                    const SpinKitSpinningCircle(color: Colors.lime),
              ),
            );
          }),
    );
  ...
  Widget season2Build(context, index) {
    return Container(
          ...
          child: Stack(
            ...
            children: [
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              "${BbCubit.get(context).season2[index]['title']}",
                              style: TextStyle(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              "${BbCubit.get(context).season2[index]['air_date']}",
                              style: TextStyle(
              ...
              Container(
                ...
                child: Center(
                  child: Text(
                    "episode ${BbCubit.get(context).season2[index]['episode']}",
                    style: TextStyle(
                        color: Colors.white,
